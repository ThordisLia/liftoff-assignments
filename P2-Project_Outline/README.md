...
### Features
1) Users can register an account with authentication that stores user data.
...
2) A geolocation functionality so the users can see any activities within the chosen radius from their location.
Users can do the following:
...
3) A filter functionality so that users can input hashtags and view listings matching the hashtags.
Users can do the following:
 input comma-separated hashtags
 edit hashtags and search again
View all listings matching hashtags

4) A filter functionality so that users can input hashtags and view listings matching the hashtags.
Users can do the following:
input comma-separated hashtags
edit hashtags and search again
view all listings matching hashtags

5) A feedback functionality so that users can leave reviews on entries.
Users can do the following:
...
6) A user functionality so that users can friend each other and see each other's feeds.
Users can do the following:
...
### Technologies
Java, Spring Boot, Thymeleaf templates, MySQL, Hibernate, Bing maps, Bootstrap
### What I'll Have to Learn
To complete this project we will need to learn how to collaborate and communicate effectively in order to hit our milestones.  This will involve following Scrum best-practices and lots of discipline.  We will also learn how to build a CRUD app from the ground up and integrate the Bing Maps API. Incorporating Bing maps is the biggest challenge so far. 
### Project Tracker
